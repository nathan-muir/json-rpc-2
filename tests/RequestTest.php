...
class RequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $request = Request::createFromString($json);
    ...
    {
        $request = Request::createFromString($json);
        $this->assertEquals((string)$request, $json);
    }
    ...
    {
        $request = Request::createFromString('{"jsonrpc": "2.0", "method": "foobar"}');
    ...
    /**
     * @expectedException \JsonRpc\Exception_ParseError
     * @dataProvider invalidJsonRequestProvider
     */
    public function testInvalidJson($json)
    {
        Request::createFromString($json);
    }
