...
class Server {
	...
	/**
	 * @var \JSON_RPC\Transport\TransportInterface
	 */
	protected $transport;

	/**
	 * @var \JSON_RPC\Dispatch\DispatchInterface
	 */
	protected $dispatch;

	/**
	 * Constructs a new \JSON_RPC\Server
	 *
	...
	private function processRequest(Request $request){
		...
		if ($request->isNotification()){
			...
			try {
			...
			} catch (\JSON_RPC\Exception $ex){ //notation used for clarity
				// Note: Any Exception wrapped in \JSON_RPC\Exception will be exposed in the response
				...
				// Note: Any Exception NOT wrapped in \JSON_RPC\Exception will NOT be exposed in the response
