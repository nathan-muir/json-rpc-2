	...
	public function getRequest()
	{
		...
		if ($this->isSourcePost()){
			...
			if ($this->isSourcePostBody()){
				...
				return \JSON_RPC\Request::createFromString( $this->getRawHttpPost() );
				...
				return \JSON_RPC\Request::createFromAssoc( $_POST );
			}
			...
			if ($this->isSourceGetParams()){
				return \JSON_RPC\Request::createFromAssoc( $_GET );
			} else { // $this->isSourceGetQueryString()
				return \JSON_RPC\Request::createFromString( $this->getQueryString() );
			}
		}
	}
