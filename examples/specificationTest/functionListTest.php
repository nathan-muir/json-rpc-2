...
$map = (require_once('functionListMethods.php'));
// create a simple dispatch object from the function mapping
$dispatch = new Server\Dispatch\FunctionListDispatch($map);
...
foreach ($specExamples as $specExample) {
    ...
    $transport = new Server\Transport\TestTransport($specExample['request'], $specExample['expected_response']);
